...
# ⚠️ Es la 137 de Oxygen, RENUMERADA a 138: aca la 137 ya la ocupa
# `tab_enablement_por_perfil`. Con dos revisiones "137" alembic tendria
# dos cabezas y el arranque —que hace `upgrade head`— no levantaria.
revision = "138"
down_revision = "137"
branch_labels = None
depends_on = None
