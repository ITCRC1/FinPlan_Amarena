...
const CASCADA: { clase: Clase; label: string; code?: string }[] = [
  ...
  { clase: "det", label: "Transportation", code: "REV_TRANSPORTATION" },
  { clase: "det", label: "Laundry", code: "REV_LAUNDRY" },
  { clase: "det", label: "Innoceana", code: "REV_INNOCEANA" },
  { clase: "det", label: "Crowther Lab", code: "REV_CROWTHER_LAB" },
  ...
  { clase: "det", label: "Transportation", code: "OPEXP_TRANSPORTATION" },
  { clase: "det", label: "Laundry", code: "OPEXP_LAUNDRY" },
  { clase: "det", label: "Innoceana", code: "OPEXP_INNOCEANA" },
  { clase: "det", label: "Crowther Lab", code: "OPEXP_CROWTHER_LAB" },
  ...
  { clase: "det", label: "Transportation", code: "OPPROFIT_TRANSPORTATION" },
  { clase: "det", label: "Laundry", code: "OPPROFIT_LAUNDRY" },
  { clase: "det", label: "Innoceana", code: "OPPROFIT_INNOCEANA" },
  { clase: "det", label: "Crowther Lab", code: "OPPROFIT_CROWTHER_LAB" },
  ...
  { clase: "det", label: "Sales & Marketing", code: "OVH_SALES_MARKETING" },
  { clase: "det", label: "Maintenance", code: "OVH_MAINTENANCE" },
  { clase: "det", label: "Information System", code: "OVH_INFORMATION_SYSTEM" },
  ...
  { clase: "det", label: "MANAGEMENT FEES (3%)", code: "MGMT_FEE_3" },
  { clase: "det", label: "MANAGEMENT FEES (5%) Royalties", code: "MGMT_FEE_5_ROYALTIES" },
  { clase: "sub", label: "TOTAL RENTA AND MANAGEMENT FEES", code: "TOTAL_RENT_MGMT_FEES" },
  { clase: "esp", label: "" },
  { clase: "det", label: "PROPERTIES INSURANCE", code: "PROPERTY_INSURANCE" },
  { clase: "sub", label: "PROPERTY INSURANCE", code: "TOTAL_PROPERTY_INSURANCE" },
  { clase: "esp", label: "" },
  { clase: "det", label: "OTHER EXPENSES", code: "OTHER_EXPENSES" },
  { clase: "sub", label: "TOTAL OTHER EXPENSES", code: "TOTAL_OTHER_EXPENSES" },
  { clase: "esp", label: "" },
  ...
  { clase: "det", label: "BANK INTEREST", code: "BANK_INTEREST" },
  { clase: "det", label: "LEASINGS / RENTS", code: "LEASINGS_RENTS" },
  { clase: "det", label: "PERDIDAS FINANCIERAS", code: "FINANCIAL_LOSSES" },
